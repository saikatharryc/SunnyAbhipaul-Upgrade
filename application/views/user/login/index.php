...
<div class="container">
	...
	<div class="page-header">
    	<h1 class="h2">all members. / <a class="btn btn-default" href="<?=base_url('users/add')?>"> <span class="glyphicon glyphicon-plus"></span> &nbsp; add new </a></h1> 
    </div>
	...
	if($stmt->rowCount() > 0)
	{
		while($row=$stmt->fetch(PDO::FETCH_ASSOC))
		{
			...
			<div class="col-xs-3">
				...
				<img src="../uploads/<?php echo $row['userPic']; ?>" class="img-rounded" width="250px" height="250px" />
				<p class="page-header">
				<span>
